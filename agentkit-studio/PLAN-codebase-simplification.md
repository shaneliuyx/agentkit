...
| 2.2 | Rebuild track: research_first.py | 🟡 attempt-11 rerun failure rediagnosed; generic extractor-contract fix shipped as `875f033` — no task-specific production hardcoding; code/test/internal-review gate passed; no further live rerun yet |
