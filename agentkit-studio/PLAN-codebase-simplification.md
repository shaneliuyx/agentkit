...
| 2.2 | Rebuild track: research_first.py | 🔴 attempt-11 rerun failed after shipped hardening `85c5999` — code/test/review gate passed, but live artifact regressed to generic agentic-AI evidence (no craft-agents-oss, 1 diagram, no integration section); no more reruns without re-diagnosis |
